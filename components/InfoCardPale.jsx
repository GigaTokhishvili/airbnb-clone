...
function InfoCardPale() {
  ...
  return (
    <div className='flex h-96 py-7 px-2 border-b cursor-pointer hover:opacity-80 hover:shadow-lg transition duration-200 ease-out '>
        <div className='relative animate-pulse bg-slate-300 rounded-lg h24 w-40 md:h-52 md:w-80 flex-shrink-0'></div>
        ...
        <div className='flex flex-col flex-grow pl-5'>
            ...
            <p className='pt-2 w-11/12 text-sm rounded-lg bg-slate-300 animate-pulse mt-2 flex-grow'></p>
