...
import HostsEstimate from '@/components/HostsEstimate';
  ...
  return (
      <div className='overflow-hidden'>
        ...
        <header className='sticky flex xl:justify-center items-center bg-white w-full top-0 z-50 shadow-md py-5 px-6'>
            <nav className='flex w-full md:w-[1200px] justify-between'>
                ...
                <div className='items-center justify-center gap-6 lg:flex'>
                    ...
                    <button onClick={() => setOverlay('signUp')} className='bg-gradient-to-r from-rose-600 via-rose-600 to-pink-600 px-6 py-3 flex gap-2 text-white rounded-lg hover:shadow-lg active:scale-95 transition transform duration-300 ease-out'>
        ...
        <main className='mx-auto mt-5 flex flex-col items-center gap-6 px-6 xl:px-0 xl:w-[1200px]'>
            ...
            <section className='md:w-[850px] flex flex-col justify-center sm:items-center'>
                ...
                <HostsProtection />
                <a className='cursor-pointer select-none w-fit border-[1px] border-neutral-800 px-4 py-2 rounded-lg hover:bg-gray-100 active:scale-95 duration-150' href='https://www.airbnb.co.uk/aircover-for-hosts' target='_blank'>Learn more</a>
            </section>
            ...
            <section className='w-screen px-6 py-12 bg-gray-100 border-b-[1px] border-gray-300 sm:py-20 sm:flex sm:flex-col sm:items-center'>
                ...
                <div className='w-full h-96 overflow-hidden rounded-2xl bg-white sm:max-w-[1200px] sm:flex'>
                    ...
                    <div className='px-6 mt-4 flex flex-col justify-center items-start md:gap-4 md:pl-16'>
                        ...
                        <button onClick={() => setOverlay('signUp')} className='mt-3 cursor-pointer select-none w-fit border-[1px] border-neutral-800 px-4 py-2 rounded-lg  hover:bg-gray-100 active:scale-95 duration-150'>Match with a superhost</button>
                    </div>
                </div>
            </section>
            ...
            {overlay === 'estimate' && <HostsEstimate offEstimate={() => setOverlay('')} /> }
